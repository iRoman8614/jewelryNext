    ...
    return (
        <>
            ...
            <main className={styles.root}>
                <ArtBlock />
                <ParallaxLayout elementsData={finalParallaxSet1} minHeight="300vh" minHeightMobile='230vh' />
                <ParallaxLayout elementsData={finalParallaxSet2} minHeight="600vh" minHeightMobile='350vh' />
                <div>
                    <InteractiveCategorySelector categories={navigationData} snakeImages={snakeImagesData} />
                </div>
                <ParallaxLayout elementsData={finalParallaxSet3}  minHeight="200vh" minHeightMobile='130vh' />
            </main>
            <Footer />
        </>
    );
