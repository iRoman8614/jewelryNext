...
const allProducts = [
    // === КОЛЬЦА (RINGS) ===
    { id: '1', category: 'rings', collection: 'zarya', image: '/images/item3.png', name: { ru: 'Аврора', en: 'Aurora' }, price: '35000' },
    { id: '2', category: 'rings', collection: 'zarya', image: '/images/item5.png', name: { ru: 'Солярис', en: 'Solaris' }, price: '38000' },
    { id: '3', category: 'rings', collection: 'zarya', image: '/images/item9.png', name: { ru: 'Гелиос', en: 'Helios' }, price: '32000' },
    { id: '4', category: 'rings', collection: 'zarya', image: '/images/item11.png', name: { ru: 'Рассвет', en: 'Dawn' }, price: '36000' },
    { id: '5', category: 'rings', collection: 'zarya', image: '/images/item4.png', name: { ru: 'Зенит', en: 'Zenith' }, price: '39000' },
    { id: 'ring-luna-1', category: 'rings', collection: 'luna', image: '/images/item2.png', name: { ru: 'Селена', en: 'Selene' }, price: '41000' },
    { id: 'ring-luna-2', category: 'rings', collection: 'luna', image: '/images/item10.png', name: { ru: 'Эндимион', en: 'Endymion' }, price: '45000' },
    { id: 'ring-luna-3', category: 'rings', collection: 'luna', image: '/images/item12.png', name: { ru: 'Лилит', en: 'Lilith' }, price: '43000' },
    { id: 'ring-luna-4', category: 'rings', collection: 'luna', image: '/images/item6.png', name: { ru: 'Ноктюрн', en: 'Nocturne' }, price: '40000' },
    { id: 'ring-luna-5', category: 'rings', collection: 'luna', image: '/images/item1.png', name: { ru: 'Фаза', en: 'Phase' }, price: '42000' },
    { id: 'ring-luna-6', category: 'rings', collection: 'luna', image: '/images/item3.png', name: { ru: 'Тень', en: 'Shadow' }, price: '46000' },

    // === БРАСЛЕТЫ (BRACELETS) ===
    { id: '1', category: 'bracelets', collection: 'reka', image: '/images/item5.png', name: { ru: 'Поток', en: 'Stream' }, price: '52000' },
    { id: '2', category: 'bracelets', collection: 'reka', image: '/images/item6.png', name: { ru: 'Изгиб', en: 'Curve' }, price: '55000' },
    { id: '3', category: 'bracelets', collection: 'reka', image: '/images/item7.png', name: { ru: 'Дельта', en: 'Delta' }, price: '53000' },
    { id: '4', category: 'bracelets', collection: 'reka', image: '/images/item9.png', name: { ru: 'Ручей', en: 'Creek' }, price: '49000' },
    { id: '5', category: 'bracelets', collection: 'reka', image: '/images/item12.png', name: { ru: 'Источник', en: 'Source' }, price: '58000' },
    { id: 'bracelet-les-1', category: 'bracelets', collection: 'les', image: '/images/item8.png', name: { ru: 'Кора', en: 'Bark' }, price: '61000' },
    { id: 'bracelet-les-2', category: 'bracelets', collection: 'les', image: '/images/item9.png', name: { ru: 'Ветвь', en: 'Branch' }, price: '59000' },
    { id: 'bracelet-les-3', category: 'bracelets', collection: 'les', image: '/images/item2.png', name: { ru: 'Листва', en: 'Foliage' }, price: '63000' },
    { id: 'bracelet-les-4', category: 'bracelets', collection: 'les', image: '/images/item4.png', name: { ru: 'Мох', en: 'Moss' }, price: '60000' },
    { id: 'bracelet-les-5', category: 'bracelets', collection: 'les', image: '/images/item1.png', name: { ru: 'Тропа', en: 'Path' }, price: '58000' },
    { id: 'bracelet-les-6', category: 'bracelets', collection: 'les', image: '/images/item6.png', name: { ru: 'Корень', en: 'Root' }, price: '65000' },
    { id: 'bracelet-les-7', category: 'bracelets', collection: 'les', image: '/images/item7.png', name: { ru: 'Чаща', en: 'Thicket' }, price: '68000' },

    // === СЕРЬГИ (EARRINGS) ===
    { id: 'earring-veter-1', category: 'earrings', collection: 'veter', image: '/images/item1.png', name: { ru: 'Шепот', en: 'Whisper' }, price: '28000' },
    { id: 'earring-veter-2', category: 'earrings', collection: 'veter', image: '/images/item2.png', name: { ru: 'Порыв', en: 'Gust' }, price: '31000' },
    { id: 'earring-veter-3', category: 'earrings', collection: 'veter', image: '/images/item4.png', name: { ru: 'Бриз', en: 'Breeze' }, price: '29000' },
    { id: 'earring-veter-4', category: 'earrings', collection: 'veter', image: '/images/item6.png', name: { ru: 'Вихрь', en: 'Vortex' }, price: '33000' },
    { id: 'earring-veter-5', category: 'earrings', collection: 'veter', image: '/images/item7.png', name: { ru: 'Эфир', en: 'Aether' }, price: '27000' },

    // === ПОДВЕСКИ (PENDANTS) ===
    { id: 'pendant-king-1', category: 'pendants', collection: 'king', image: '/images/item10.png', name: { ru: 'Корона', en: 'Crown' }, price: '48000' },
    { id: 'pendant-king-2', category: 'pendants', collection: 'king', image: '/images/item11.png', name: { ru: 'Скипетр', en: 'Scepter' }, price: '51000' },
    { id: 'pendant-king-3', category: 'pendants', collection: 'king', image: '/images/item12.png', name: { ru: 'Трон', en: 'Throne' }, price: '55000' },
    { id: 'pendant-king-4', category: 'pendants', collection: 'king', image: '/images/item9.png', name: { ru: 'Мантия', en: 'Mantle' }, price: '49000' },
    { id: 'pendant-king-5', category: 'pendants', collection: 'king', image: '/images/item8.png', name: { ru: 'Держава', en: 'Orb' }, price: '53000' },
    { id: 'pendant-king-6', category: 'pendants', collection: 'king', image: '/images/item3.png', name: { ru: 'Регалия', en: 'Regalia' }, price: '50000' },

    // === ОЖЕРЕЛЬЯ (NECKLACES) ===
    { id: 'necklace-taina-1', category: 'necklaces', collection: 'taina', image: '/images/item5.png', name: { ru: 'Загадка', en: 'Enigma' }, price: '75000' },
    { id: 'necklace-taina-2', category: 'necklaces', collection: 'taina', image: '/images/item3.png', name: { ru: 'Секрет', en: 'Secret' }, price: '79000' },
    { id: 'necklace-taina-3', category: 'necklaces', collection: 'taina', image: '/images/item8.png', name: { ru: 'Мистерия', en: 'Mystery' }, price: '82000' },
    { id: 'necklace-taina-4', category: 'necklaces', collection: 'taina', image: '/images/item9.png', name: { ru: 'Шифр', en: 'Cipher' }, price: '77000' },
    { id: 'necklace-taina-5', category: 'necklaces', collection: 'taina', image: '/images/item10.png', name: { ru: 'Иллюзия', en: 'Illusion' }, price: '85000' },
    { id: 'necklace-taina-6', category: 'necklaces', collection: 'taina', image: '/images/item2.png', name: { ru: 'Грёза', en: 'Reverie' }, price: '81000' },
    { id: 'necklace-taina-7', category: 'necklaces', collection: 'taina', image: '/images/item7.png', name: { ru: 'Оракул', en: 'Oracle' }, price: '88000' },
    { id: 'necklace-taina-8', category: 'necklaces', collection: 'taina', image: '/images/item4.png', name: { ru: 'Пророчество', en: 'Prophecy' }, price: '92000' },
];
