...
export const paralaxSet2 = [
    ...
    {id: 16, type: 'image', src: '', alt: '', top: '79%', left: '48%', width: '27%', zIndex: 7, speed: 7},
    {id: 17, type: 'image', src: '', alt: '', top: '83%', left: '60%', width: '24%', zIndex: 3, speed: -12},
    {id: 18, type: 'text', top: '95%', left: '15%', width: '70%', zIndex: 5, speed: 3},
];
