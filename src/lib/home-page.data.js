...
export const paralaxSet2 = [
    ...
    {id: 9, type: 'image', src: '', alt: '', top: '17%', left: '65%', width: '23%', zIndex: 3, speed: 5},
    {id: 10, type: 'image', src: '', alt: '', top: '28%', left: '10%', width: '35%', zIndex: 3, speed: -12},
    {id: 11, type: 'image', src: '', alt: '', top: '33%', left: '60%', width: '23%', zIndex: 2, speed: -4},
    {id: 12, type: 'image', src: '', alt: '', top: '45%', left: '12%', width: '25%', zIndex: 4, speed: -10},
    {id: 13, type: 'text', top: '45%', left: '50%', width: '45%', zIndex: 5, speed: 3},
    {id: 14, type: 'image', src: '', alt: '', top: '54%', left: '60%', width: '24%', zIndex: 6, speed: 10},
    {id: 15, type: 'image', src: '', alt: '', top: '62%', left: '20%', width: '24%', zIndex: 8, speed: -6},
    {id: 16, type: 'image', src: '', alt: '', top: '69%', left: '48%', width: '27%', zIndex: 7, speed: 7},
    {id: 17, type: 'image', src: '', alt: '', top: '73%', left: '60%', width: '24%', zIndex: 3, speed: -12},
    {id: 18, type: 'text', top: '86%', left: '15%', width: '70%', zIndex: 5, speed: 3},
];
